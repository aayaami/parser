...
class Ia41RuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //*[following-sibling::*[descendant::*[contains(concat(" ",normalize-space(@class)," ")," ya-share2 ")]]][last()]/following-sibling::*
